...
class CfgMovesMaleSdr: CfgMovesBasic
{
	class States
	{
		...
		class AUR_01_Aim: cargo_base_Rope
		{
			...
			leftHandIKCurve[]={1};
			minPlayTime = 0.1;								
			file="fr\gsri\aur\anims\Rup_RopeFX_01_aim.rtm";	/// what file is going to be played in this state
			speed=100000;											
			ConnectTo[]={};											
			InterpolateTo[]=										
			{
		...
		class AUR_01_Aim_Idling: AUR_01_Aim
		{
			...
			headBobStrength=0;
			soundEnabled=1;
			file="fr\gsri\aur\anims\Rup_RopeFX_01_aim1.rtm";
			speed=-8;												
			ConnectTo[]=
			{
				"AUR_01_Aim",
		...
		class AUR_01_Idle: cargo_base_idle
		{
			...
			file="fr\gsri\aur\anims\Rup_RopeFX_01_idle.rtm";
			speed=100000;
			minPlayTime = 0.1;
		...
		class AUR_01_Idle_Idling: AUR_01_Idle
		{
			...
			headBobStrength=0;
			soundEnabled=1;
			file="fr\gsri\aur\anims\Rup_RopeFX_01_idle1.rtm";
			speed=-10;
			ConnectTo[]=
			{
				"AUR_01_Idle",
		...
		class AUR_01_Aim_Pistol: cargo_basepistol
		{
			...
			file="fr\gsri\aur\anims\Rup_RopeFX_01_aimpistol.rtm";
		...
		class AUR_01_Aim_Pistol_Idling: AUR_01_Aim_Pistol
		{
			...
			headBobStrength=0;
			soundEnabled=1;
			file="fr\gsri\aur\anims\Rup_RopeFX_01_aimpistol1.rtm";
			speed=-8;
			ConnectTo[]=
			{
				"AUR_01_Aim_Pistol",
		...
		class AUR_01_Idle_Pistol: cargo_base_idle_pistol
		{
			...
			file="fr\gsri\aur\anims\Rup_RopeFX_01_idlepistol.rtm";
			speed=100000;
			aiming="aimingRifleSlingDefault";
			aimingBody="aimingUpRifleSlingDefault";
			InterpolateTo[]=
		...
		class AUR_01_Idle_Pistol_Idling: AUR_01_Idle
		{
			...
			headBobStrength=0;
			soundEnabled=1;
			file="fr\gsri\aur\anims\Rup_RopeFX_01_idlepistol1.rtm";
			speed=-10;
			ConnectTo[]=
			{
				"AUR_01_Idle_Pistol",
		...
		{
			actions="AUR_01_PistolActions";
			file="fr\gsri\aur\anims\Rup_RopeFX_01_aimtopistol.rtm";
			speed=2;
			ConnectTo[]=
			{
		...
		{
			actions="AUR_01_PistolActions";
			file="fr\gsri\aur\anims\Rup_RopeFX_01_aimtopistol_end.rtm";
			speed=1.875;
			ConnectTo[]=
			{
				"AUR_01_Aim_Pistol",
		...
		{
			actions="AUR_01_PistolActions";
			file="fr\gsri\aur\anims\Rup_RopeFX_01_aimFrompistol.rtm";
			speed=2.3076921;
			ConnectTo[]=
			{
		...
		{
			actions="AUR_01_Actions";
			file="fr\gsri\aur\anims\Rup_RopeFX_01_aimfrompistol_end.rtm";
			aiming="aimingDefault";
		...
		class AUR_01_Die: DefaultDie
		{
			...
			file="fr\gsri\aur\anims\Rup_RopeFX_01_die.rtm";
			speed=1;
			looped="false";
			terminal=1;
			ragdoll=1;
...
class CfgGesturesMale
{
	...
	class States
	{
		...
		{
			file="fr\gsri\aur\anims\Rup_RopeFX_01_Jump1.rtm";
			minPlayTime= 1;
			looped = 0;
			speed = 0.2;
			mask = "AUR_Jump_Rope";
		...
		{
			file="fr\gsri\aur\anims\Rup_RopeFX_01_Jump2.rtm";
			speed = 0.00000001;
		};
		class AUR_01_Jump3: AUR_01_Jump1
		{
			file="fr\gsri\aur\anims\Rup_RopeFX_01_Jump3.rtm";
			speed = 0.85;
		};
	};
	class BlendAnims
